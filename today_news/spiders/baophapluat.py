...
class BaophapluatSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "越南法律报"
    # allowed_domains = ["baophapluat.vn"]
    start_urls = ["https://baophapluat.vn/sitemaps/google-news.xml"]
    ...
    def parse_detail(self, response):
        ...
        d1 = response.xpath('//div[contains(@class, "article__body")]')
        ...
        if not itm.get('images'):
            img_list = response.xpath('//figure[@class="article-content__avatar"]//img')
            if img_list:
