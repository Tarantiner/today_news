...
class CtsSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "华视新闻网"
    # allowed_domains = ["news.cts.com.tw"]
    start_urls = ["https://news.cts.com.tw/sitemap_cts_google.xml"]
    ...
    def parse_detail(self, response):
        ...
        d1 = response.xpath('//div[@class="article-content"]')
        ...
        if not itm.get('images'):
            img_list = d1.xpath('//figure[@class="news-detail-cover"]//img')
            if img_list:
