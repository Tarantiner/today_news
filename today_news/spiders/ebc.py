...
class EbcSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "东森新闻网"
    # allowed_domains = ["ebc.net.tw"]
    start_urls = ["https://news.ebc.net.tw/sitemap/realtime.xml"]
    ...
    def parse_detail(self, response):
        ...
        if not itm.get('images'):
            img_list = d1.xpath('//div[@class="article_cover"]//img')
            if img_list:
