...
class FtvnewsSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "民视新闻网"
    # allowed_domains = ["ftvnews.com.tw"]
    start_urls = ["https://www.ftvnews.com.tw/sitemap/sitemap.xml"]
    ...
    def parse_detail(self, response):
        ...
        d1 = response.xpath('//div[@id="preface"]')
        ...
        if not itm.get('images'):
            img_list = d1.xpath('//figure[@class="article-cover"]//img')
            if img_list:
