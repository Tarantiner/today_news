...
class GiaoducthoidaiSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "越南教育与时代报"
    # allowed_domains = ["giaoducthoidai.com"]
    start_urls = ["https://giaoducthoidai.vn/sitemaps/google-news.xml"]
