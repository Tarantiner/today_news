...
class JijiSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "时事社"
    allowed_domains = ["jiji.com"]
    start_urls = [
        "https://www.jiji.com/sitemap/sitemap_int.xml",  # 国际
        "https://www.jiji.com/sitemap/sitemap_pol.xml",  # 政治
        "https://www.jiji.com/sitemap/sitemap_eco.xml",  # 经济
        "https://www.jiji.com/sitemap/sitemap_flash.xml",  # 速报
    ]

    def parse_detail(self, response):
        d1 = response.xpath('//div[contains(@class, "ArticleText")]')
