...
class JoongangFxSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "中央日報"
    allowed_domains = ["joongang.co.kr"]
    start_urls = ["https://www.joongang.co.kr/sitemap/latest-articles"]

    def parse_detail(self, response):
        itm = response.meta['item']

        clean_text = response.xpath('//*[@id="article_body"]/p/text()')
        txt_list = []
