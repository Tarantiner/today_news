...
class KhanFxSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "京乡新闻"
    allowed_domains = ["khan.co.kr"]
    start_urls = ["https://www.khan.co.kr/sitemap/latest-articles.xml"]

    def parse_detail(self, response):
        itm = response.meta['item']

        clean_text = response.xpath('//*[@id="articleBody"]/p/text()')
        txt_list = []
