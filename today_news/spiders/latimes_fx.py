...
class LatimesFxSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "洛杉矶时报"
    allowed_domains = ["latimes.com", "brightspotcdn.com"]
    start_urls = ["https://www.latimes.com/news-sitemap-content.xml", "https://www.latimes.com/news-sitemap-latest.xml"]

    def parse_detail(self, response):
        itm = response.meta['item']

        clean_text = response.xpath('//div[contains(@class, "page-content")]//div[@data-element="story-body"]/p/text()')
        txt_list = []
