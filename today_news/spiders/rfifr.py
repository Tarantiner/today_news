...
class RfifrSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "法国国际广播电台"
    ...
    def parse_detail(self, response):
        d1 = response.xpath('//div[contains(@class, "t-content__body")]')
        clean_text = d1.xpath('.//p[not(contains(@class, "promo"))]').xpath('string(.)')
        txt_list = []
