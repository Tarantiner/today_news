...
class SankeiSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "产经新闻"
    allowed_domains = ["sankei.com"]
    start_urls = [
        "https://www.sankei.com/feeds/sitemap-politics/?outputType=xml&from=0",
        "https://www.sankei.com/feeds/sitemap-world/?outputType=xml&from=0",
        "https://www.sankei.com/feeds/sitemap-economy/?outputType=xml&from=0",
    ]
    ...
    def parse_detail(self, response):
        ...
        if not itm.get('images'):
            img_list = response.xpath('//div[@class="figure_image"]//img')
            if img_list:
