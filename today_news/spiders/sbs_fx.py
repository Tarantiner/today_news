...
class SbsFxSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "SBS新闻"
    allowed_domains = ["sbs.co.kr"]
    start_urls = ["https://news.sbs.co.kr/news/sitemap.do"]

    def parse_detail(self, response):
        itm = response.meta['item']

        clean_text = response.xpath('//*[@id="container"]//div[@itemprop="articleBody"]/text()')
        txt_list = []
