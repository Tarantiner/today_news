...
class SetnSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "三立新闻网"
    # allowed_domains = ["setn.com"]
    start_urls = ["https://www.setn.com/sitemapGoogleNews.xml"]
    ...
    def parse_detail(self, response):
        ...
        d1 = response.xpath('//div[@itemprop="articleBody"]//article')
