...
class KmibFxSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "西贡解放日报"
    allowed_domains = ["sggp.org.vn"]
    start_urls = ["https://cn.sggp.org.vn/sitemaps/google-news.xml"]

    def parse_detail(self, response):
        itm = response.meta['item']

        clean_text = response.xpath('//div[@itemprop="articleBody"]/p/text()')
        txt_list = []
