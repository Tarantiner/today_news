...
class TokyoNpFxSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "东京新闻"
    allowed_domains = ["tokyo-np.co.jp"]
    start_urls = ["https://www.tokyo-np.co.jp/sitemap_n.xml"]

    def parse_detail(self, response):
        itm = response.meta['item']

        clean_text = response.xpath('//*[@id="entry"]/div[@class="block"]/text()')
        txt_list = []
