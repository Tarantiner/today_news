...
class ZingSpider(scrapy.Spider, SpiderTxtParser, SpiderUtils):
    name = "Zing新闻"
    allowed_domains = ["znews.vn"]
    start_urls = [
        "https://znews.vn/sitemap/sitemap-news.xml"
        # "https://znews.vn/sitemap/cate/thoi-su.xml",  # 消息
        # "https://znews.vn/sitemap/cate/phap-luat.x",  # 法律
        # "https://znews.vn/sitemap/cate/the-gioi.xm",  # 世界
        # "https://znews.vn/sitemap/cate/giai-tri.xm",  # 娱乐
        # "https://znews.vn/sitemap/cate/the-thao.xm",  # 体育
    ]

    def parse_detail(self, response):
        d1 = response.xpath('//div[@class="the-article-body"]')
